...
const apartments = [
  {
    ...
    image: venezia,
    size: "Großzügig", // Falls du die genaue m²-Zahl noch hast, hier eintragen
    guests: 5,
    price: "Ab 75 €",
    amenities: ["WLAN", "Garagenstellplatz", "Bettwäsche inkl.", "Endreinigung inkl.", "Zentrale Lage", "Kinderfreundlich"],
  },
  {
    title: "Casanova",
